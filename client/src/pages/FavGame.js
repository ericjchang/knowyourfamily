...
import IndividualCard from '../components/GameCard'
...
export default () => {
  ...
  return (
      <>
                  ...
                  <Col sm={8}>
                    <Form>
                        <Form.Group controlId="formBasicEmail" className="input">
                            <Form.Control type="email" placeholder="First Name" className="inputHeight"/>
                        </Form.Group>
                        <Form.Group controlId="formBasicEmail" className="input">
                            <Form.Control type="text" placeholder="Last Name / Family Name" className="inputHeight"/>
                        </Form.Group>
                        <Form.Group controlId="formBasicEmail" className="input">
                            <Form.Control type="text" placeholder="Date Of Birth" className="inputHeight"/>
                        </Form.Group>
                        <Form.Group controlId="formBasicEmail" className="input">
                            <Form.Control type="text" placeholder="Gender" className="inputHeight"/>
                        </Form.Group>
                        <Form.Group controlId="formBasicPassword" className="input">
                            <Form.Control type="password" placeholder="Password" className="inputHeight"/>
                        </Form.Group>
                        <Button variant="flat" size="xl" type="submit">SUBMIT</Button>  
                    </Form>
                  </Col>
                  {/* <Col sm={3}></Col> */}
                </Col>
          ...
          {/* Cards */}
          <Container> <IndividualCard></IndividualCard> </Container>
          {/* Footer */}
